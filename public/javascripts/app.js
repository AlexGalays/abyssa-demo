...
},{"./Transition":6,"./util":9}],5:[function(require,module,exports){
...
},{"./util":9,"q":15}],7:[function(require,module,exports){
...
},{"./Router":3,"./State":4,"./Transition":6,"./util":9}],9:[function(require,module,exports){
...
},{"handlebars/lib/handlebars/base":11,"handlebars/lib/handlebars/runtime":12,"handlebars/lib/handlebars/utils":13}],15:[function(require,module,exports){
...
},{"q":18}],18:[function(require,module,exports){
...
router.transition.ended.addOnce(function(_) {
...
function finishedLoading(news) {
  return spinner.hide().then(function(_) {
   return news;
  });
}
...
function getNews() {
  ...
  var latency = Q.defer();
  setTimeout(function(_) {
   return latency.resolve();
  }, 500 * Math.random());

  return latency.promise.then(function(_) {
...
function showContent(content) {
  return Async(spinner.hide()).then(function(_) {
   return panelContent.html(content);
  });
}
...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(((stack1 = helpers.link || depth0.link),stack1 ? stack1.call(depth0, "news.item.show", options) : helperMissing.call(depth0, "link", "news.item.show", options)))
    + ">\r\n      <div>\r\n        <div class=\"color ";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(((stack1 = helpers.link || depth0.link),stack1 ? stack1.call(depth0, "news.item.edit", options) : helperMissing.call(depth0, "link", "news.item.edit", options)))
    + ">Edit</a>\r\n  <div><pre>";
